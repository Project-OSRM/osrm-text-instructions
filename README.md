...
* **Global**: Text instructions are available in over a dozen languages via [Transifex](https://explore.transifex.com/project-osrm/osrm-text-instructions/). [Abbreviations](languages/abbreviations/README.md) and [advanced grammatical transformations](languages/grammar/README.md) are available in some languages.
...
[Help translate OSRM Text Instructions](https://explore.transifex.com/project-osrm/osrm-text-instructions/)
