...
const grammarTests = {
    ...
    'ru': [
        ...
        ['Черкасовская авторазвязка', 'accusative', 'Черкасовскую авторазвязку'],
        ['Черкасовская авторазвязка', 'dative', 'Черкасовской авторазвязке'],
        ['Черкасовская авторазвязка', 'genitive', 'Черкасовской авторазвязки'],
        ['Черкасовская авторазвязка', 'prepositional', 'Черкасовской авторазвязке'],
