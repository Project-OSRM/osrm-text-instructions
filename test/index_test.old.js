...
tape.test('v5 tokenize', function(assert) {
  ...
  var formatsTokens = v5Compiler.tokenize(
    'en',
  ...
  var capitalizesTokens = v5Compiler.tokenize(
    'en',
  ...
  var formatsGrammaticalTokens = v5Compiler.tokenize(
    'ru',
...
tape.test('v5 wayName', function(assert) {
  ...
  [
    ...
    assert.equal(
      v5Compiler.getWayName('en', c[0], { classes: ['motorway'] }),
      c[1],
